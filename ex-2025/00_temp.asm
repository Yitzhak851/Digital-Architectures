...
main:
    ...
    addi $t0, $0, 4
    sw $t0, 0x10000110($zero)   # save word the array size

    lw $t0, 0x10000000($zero)   # $s0 = sizes_of_array (number of elements in the array)
...
loop:
    beq $t0, $0, endloop            # if $t0 = 0 goto endloop
